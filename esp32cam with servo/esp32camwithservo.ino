const char* ssid ="TOPNET_1708";
const char* password = "sfaxi12345";
// const char* ssid ="I-Space-09";
// const char* password = "I-Space_147b\"4('fdvbc4";        
int angle1Value1 = 180;   
int angle1Value2 = 90;   
#include <WiFi.h>
...
<html>
    ...
    <body>
        <figure>
          ...
          <canvas id="position" width="320" height="320"></canvas><br>
        ...
        <script type="text/javascript">
          ...
          canvas.onclick = function(e){  
            ...
            if (cmdState==0) {
              ...
              canvas_arc(context,2,e.offsetX,e.offsetY,35,0,2*Math.PI,true,0,"green",0,1);
          ...
          context.fillStyle = "white";
          context.fillRect(0, 0, canvas.width, canvas.height);
          canvas_arc(context,2,canvas.width/2,canvas.height/2,30,0,2*Math.PI,true,1,"green",0,1)
          canvas_arc(context,2,canvas.width/2,canvas.height/2,35,0,2*Math.PI,true,0,"green",0,1)
          
          function canvas_arc(context, linewidth,x0,y0,r,sAngle,eAngle,counterclockwise,fill,color,rotate,globalAlpha) {
            ...
            context.beginPath();
            context.arc(x0,y0,r,sAngle,eAngle,counterclockwise);
            if (fill==0)
              context.stroke();
            else
              context.fill();
